#!/usr/bin/env bash
# Precompute text embeddings for the selected converted DOMINO datasets.
# Usage:
#   bash scripts/domino/precompute_domino_text_embeds.sh [num_gpus] [hydra_overrides...]
...
echo "Precomputing text embeddings for ${TOTAL_EPISODES} DOMINO demonstrations across ${#TASK_SPECS[@]} task levels."
