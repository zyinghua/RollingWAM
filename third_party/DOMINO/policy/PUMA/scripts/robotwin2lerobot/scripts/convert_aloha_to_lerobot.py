"""
Modified from https://github.com/RoboTwin-Platform/RoboTwin/blob/main/policy/GO1/scripts/convert_aloha_data_to_lerobot_robotwin.py
...
def port_aloha(
    ...
    *,
    ...
    # Sort files to ensure consistent episode ordering
    hdf5_files.sort()
    ...
    if hasattr(dataset, 'consolidate'):
        ...
        print("Note: consolidate() method not available in this LeRobot version.")
